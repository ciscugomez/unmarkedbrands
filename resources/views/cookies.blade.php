        ...
        <div class="">
            ...
            <div class= "text-center xl:mx-auto max-w-screen-2xl py-10 text-[#5E5F5E]">
                <div class="px-5 xl:px-0 grid grid-cols-1 xl:grid-cols-3">
                    <a href="{{ route('legal') }}" class="xl:mx-5 text-normal py-2 xl:px-6 text-white bg-[#D1D2D1]">
                    ...
                    <a href="{{ route('cookies') }}" class="text-normal py-2 xl:px-6 text-white  bg-quienes opacity-75">
