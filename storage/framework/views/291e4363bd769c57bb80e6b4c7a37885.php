                ...
                <div class="flex flex-col xl:flex-row justify-between gap-5 xl:gap-32">
                    ...
                    <div class="flex justify-center xl:justify-end">
                        <div class="max-w-3xl">
                            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('contacts.form')->html();
} elseif ($_instance->childHasBeenRendered('Y0Av31v')) {
    $componentId = $_instance->getRenderedChildComponentId('Y0Av31v');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y0Av31v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y0Av31v');
} else {
    $response = \Livewire\Livewire::mount('contacts.form');
    $html = $response->html();
    $_instance->logRenderedChild('Y0Av31v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
    ...
    <div class="text-[#D7D7D7] bg-quienes text-center xl:text-ms xl:mx-auto  py-14 flex justify-center">
        <div class="max-w-5xl xl:max-w-screen-xl grid grid-cols-1 w-full xl:grid-cols-2 items-center mx-5">
            ...
            <div class="mx-auto my-10 flex justify-center xl:justify-end w-full">
                <img src="<?php echo e(asset('img/Group-50.svg')); ?>" alt="imagen"/>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/unmarkedbrands/www/resources/views/about-us.blade.php ENDPATH**/ ?>