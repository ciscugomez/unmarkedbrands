...
} elseif ($_instance->childHasBeenRendered('l1689135536-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1689135536-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1689135536-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1689135536-0');
} else {
    $response = \Livewire\Livewire::mount('likes.like', ['likeable' => $publication, 'user' => auth()->user()]);
    $html = $response->html();
    $_instance->logRenderedChild('l1689135536-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH C:\Users\prueb\Herd\Unmarked-web\resources\views/livewire/publications/card.blade.php ENDPATH**/ ?>