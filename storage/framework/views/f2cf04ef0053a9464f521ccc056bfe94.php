...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','placeholder' => 'Email','class' => 'block mt-1 w-full','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','placeholder' => 'Contraseña','class' => 'block mt-1 w-full','type' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox"
                        class=" border-gray-300 text-indigo-600 shadow-sm focus:ring-secondary" name="remember">
                    <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Recuérdame')); ?></span>
                </label>
            </div>
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <div>
                            <a class="text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('password.request')); ?>">
                                <?php echo e(__('¿Has olvidado la contraseña?')); ?>

                            </a>
                        </div>
                    <?php endif; ?>
                    <p class="text-sm text-gray-600">
                        <?php echo e(__('¿No tienes cuenta?')); ?><a class="text-secondary" href="<?php echo e(route('register')); ?>">
                            <?php echo e(__('Únete Gratis')); ?>
...
<?php endif; ?>
<?php /**PATH /home/unmarkedbrands/www/resources/views/auth/login.blade.php ENDPATH**/ ?>