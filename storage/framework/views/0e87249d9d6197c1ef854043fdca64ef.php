<div class="sharing-buttons grid grid-cols-2 lg:grid-cols-4 w-full lg:w-fit">
    <a class="col-span-1 border-2 duration-200 ease inline-flex justify-center items-center mb-1 mr-1 transition py-1 px-2 text-sm text-white border-gray-600 bg-gray-600 hover:bg-gray-700 hover:border-gray-700"
        target="_blank" rel="noopener" href="https://www.facebook.com/sharer/sharer.php?u=https://unmarkedbrands.com/"
    ...
    <a class="col-span-1 border-2 duration-200 ease inline-flex justify-center items-center mb-1 mr-1 transition py-1 px-2 text-sm text-white border-gray-600 bg-gray-600 hover:bg-gray-700 hover:border-gray-700"
        target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url=https://unmarkedbrands.com/&text="
    ...
    <a class="col-span-1 border-2 duration-200 ease inline-flex justify-center items-center mb-1 mr-1 transition py-1 px-2 text-sm text-white border-gray-600 bg-gray-600 hover:bg-gray-700 hover:border-gray-700"
        ...
        href="https://www.linkedin.com/shareArticle?mini=true&url=http://unmarkedbrands.com/&title=&summary=&source="
    ...
    <a class="col-span-1 border-2 duration-200 ease inline-flex justify-center items-center mb-1 mr-1 transition py-1 px-2 text-sm text-white border-gray-600 bg-gray-600 hover:bg-gray-700 hover:border-gray-700"
        target="_blank" rel="noopener" href="https://api.whatsapp.com/send?text=%0ahttps://unmarkedbrands.com/"
...
<?php /**PATH /home/unmarkedbrands/www/resources/views/livewire/publications/partials/shares.blade.php ENDPATH**/ ?>