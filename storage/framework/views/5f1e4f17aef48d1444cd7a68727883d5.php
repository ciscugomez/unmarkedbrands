...
} elseif ($_instance->childHasBeenRendered('x100BLA')) {
    $componentId = $_instance->getRenderedChildComponentId('x100BLA');
    $componentTag = $_instance->getRenderedChildComponentTagName('x100BLA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x100BLA');
} else {
    $response = \Livewire\Livewire::mount('newsletter');
    $html = $response->html();
    $_instance->logRenderedChild('x100BLA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\prueb\Herd\Unmarked-web\resources\views/layouts/footer.blade.php ENDPATH**/ ?>